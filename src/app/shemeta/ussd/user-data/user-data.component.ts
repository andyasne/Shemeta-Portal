...
export class UserDataComponent implements OnInit, OnDestroy {
	...
	constructor(
		...
		private store: Store<AppState>,private ussdAppService: UssdAppService,
	) { }
	...
	//	this.init(); // Remove this line, just loading imitation
	}
	...
	getUserData(){
		...
		this.ussdAppService.getUserData().pipe(
			tap(res => {
			  if (res) {
				this.userData =  res;
			  }
